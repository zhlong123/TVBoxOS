...
public final class UiLayoutConfig {
    ...
    public static final int DEFAULT_GRID_SPACING_MM = 28;
    public static final int DEFAULT_ITEM_MARGIN_MM = 12;
    public static final int DEFAULT_FOCUS_SCALE_PERCENT = 112;
    ...
    public static int getGridSpacingMm() {
        return clamp(Hawk.get(HawkConfig.UI_GRID_SPACING, DEFAULT_GRID_SPACING_MM), 12, 48);
    }

    public static int getItemMarginMm() {
        return clamp(Hawk.get(HawkConfig.UI_ITEM_MARGIN, DEFAULT_ITEM_MARGIN_MM), 4, 24);
    }
    ...
    public static boolean apply(String key, String value) {
        ...
        switch (key) {
            ...
            case HawkConfig.UI_GRID_SPACING:
                Hawk.put(key, clamp(parseInt(value, DEFAULT_GRID_SPACING_MM), 12, 48));
                return true;
            case HawkConfig.UI_ITEM_MARGIN:
                Hawk.put(key, clamp(parseInt(value, DEFAULT_ITEM_MARGIN_MM), 4, 24));
                return true;
