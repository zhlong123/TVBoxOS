...
public class SeriesFlagAdapter extends BaseQuickAdapter<VodInfo.VodSeriesFlag, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, VodInfo.VodSeriesFlag item) {
        ...
        if (item.selected) {
            ...
            tvSeries.setTextColor(helper.itemView.getResources().getColor(R.color.ui_accent_bright));
        } else {
            select.setVisibility(View.GONE);
            tvSeries.setTextColor(helper.itemView.getResources().getColor(R.color.ui_text_secondary));
        }
