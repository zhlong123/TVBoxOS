...
public class HomeActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        UiLayoutConfig.ensureNoClipOnParents(this.contentLayout);
        ...
        this.mGridView.setOnItemListener(new TvRecyclerView.OnItemListener() {
            ...
            public void onItemSelected(TvRecyclerView tvRecyclerView, View view, int position) {
                if (view != null) {
                    ...
                    sortAdapter.setActivePosition(position);
    ...
    private void initViewModel() {
        ...
        sourceViewModel.sortResult.observe(this, new Observer<AbsSortXml>() {
            ...
            public void onChanged(AbsSortXml absXml) {
                ...
                sortAdapter.syncActivePosition(currentSelected);
...
//                                if (!useCacheConfig) Toast.makeText(HomeActivity.this, "自定义jar加载成功", Toast.LENGTH_SHORT).show();
    ...
    private void initViewPager(AbsSortXml absXml) {
        if (sortAdapter.getData().size() > 0) {
            ...
            syncUserHomeVisibility(currentSelected);
        }
    }

    /** 仅隐藏主页（豆瓣热播），Grid 分类页交给 ViewPager 滑动，避免切换时全部分类闪屏。 */
    private void syncUserHomeVisibility(int selected) {
        for (int i = 0; i < fragments.size(); i++) {
            BaseLazyFragment fragment = fragments.get(i);
            ...
            if (i == selected) {
                ...
                UserFragment.clearHotListOverlay();
    ...
    public void onBackPressed() {
        ...
        if (baseLazyFragment instanceof GridFragment) {
            ...
            if (grid.dismissFilterIfShowing()) {
                return;
            }
        ...
        public void run() {
            if (sortChange) {
                ...
                if (sortFocused != currentSelected) {
                    ...
                    syncUserHomeVisibility(sortFocused);
